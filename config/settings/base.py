...
WEB_APP_BASE_URL = env("WEB_APP_BASE_URL", default=APP_BASE_URL)
...
AI_DAILY_TOKEN_LIMIT_PER_USER = env.int("AI_DAILY_TOKEN_LIMIT_PER_USER", default=20000)
AI_DAILY_ESTIMATED_COST_LIMIT_PER_USER = env.float("AI_DAILY_ESTIMATED_COST_LIMIT_PER_USER", default=0)
AI_MONTHLY_ESTIMATED_COST_LIMIT_PER_ORGANIZATION = env.float(
    "AI_MONTHLY_ESTIMATED_COST_LIMIT_PER_ORGANIZATION",
    default=0,
)
AI_CASE_DIAGNOSTIC_TURN_LIMIT = env.int("AI_CASE_DIAGNOSTIC_TURN_LIMIT", default=8)
